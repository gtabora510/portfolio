...
Note that **all existing firmwide policies apply to your use of GitHub Copilot**, including the Code of Conduct, Information Safeguarding and Barriers Policy (and applicable supplement), Information Confidentiality Classifications Standard, and Acceptable Use of Technology and Information Assets Policy.
...
4. Authenticate your local IDE to your GitHub account:
   ...
   3. Enter `<your SID>` in the **Username** field, leave the **Password** blank, then click **Sign in with your identity provider**.
   ...
   7. Ensure your SID shows in the "Verify your GitHub identity [SID]" statement, then click **Authorize GitHub Copilot Plugin**. A success message displays.
...
4. Authorize VS Code to use GitHub Copilot:
   ...
   5. Ensure your SID shows in the "...wants to access your `<SID>` account", then click **Authorize Visual-Studio-Code**.
   ...
   8. Again, ensure your SID shows in the "...wants to access your `<SID>` account", then click **Authorize Visual-Studio-Code**.
...
5. Confirm that you are signed in with your `SID` account by clicking on the profile icon in the lower, left-hand corner of your IDE.
...
7. Sign in to GitHub Copilot using your GitHub account (`<SID>`).
...
8. Enter your GitHub username as `<your SID>`, leave the **Password** field blank, then click **Sign in with your identity provider**.
...
4. Authenticate your IDE to your GitHub account:
   ...
   3. Enter your `<SID>` in the **Username** field, leave the **Password** blank, then click **Sign in with your identity provider**.
      ...
      Or, if you have already logged into the GitHub account directly, click the **Continue** button that is aligned with your `<SID>` account:
...
4. Authorize VS Code to use GitHub Copilot:
   1. Select the **User** icon from the lower-left toolbar, then select **Sign in with GitHub to use GitHub Copilot**.
   2. Click the **Sign in** button that is aligned with your `<SID>` account.
   3. Enter your `<SID>` in the **Username** field, leave the **Password** blank, then click **Sign in with your identity provider**.
   4. Click **Continue** when prompted to "SSO."
   ...
   7. Ensure your SID shows in the "...wants to access your `<SID>` account", then click **Authorize Visual-Studio-Code**.
5. Confirm that you are signed in with your `<SID>` account by clicking on the profile icon in the lower, left-hand corner of your IDE.
6. Review the Next Steps to begin leveraging Copilot.
...
### Scenario 1: You Cannot Install the Plugin but Can Log in to GitHub with your `<SID>` but Do Not See the "Copilot Business is active for your account" Message
